...
def create_app(config_name='dev'):
    """Flask Application Factory for Government Interoperability Middleware"""
    app = Flask(__name__,
    ...
    def health_check():
        return jsonify({
            'status': 'active',
            'middleware': 'Government Interoperability & Federated Service Delivery Framework',
