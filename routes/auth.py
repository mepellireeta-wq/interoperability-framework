...
def login():
    ...
    username = str(data.get('username') or data.get('user') or request.args.get('username') or '').strip()
    password = str(data.get('password') or data.get('pass') or request.args.get('password') or '').strip()
